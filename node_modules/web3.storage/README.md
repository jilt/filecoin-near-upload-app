...
## Edit to the main package to fix <a href="https://github.com/web3-storage/web3.storage/issues/343#issuecomment-1119961957" target="_blank">this issue</a>
...
The code imports have been modified in order for the upload button to work, please refer to the web3.storage repository issue to see the changes I have made.
